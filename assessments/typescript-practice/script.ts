...
const results : string = roundWithUnit(52.5, " tons");
console.log(results);

// ● Declare an interface called Sauce that contains the following properties:
// ○ name - string
// ○ spiceLevel - number
// ○ awesome - boolean
interface Sauce {
...
// sauce is found.)
function getSauceByName(arrayOfSauces: Sauce[], name:string): Sauce|undefined {
...
// have awesome true.
function getAwesomeSauces(arrayOfSauces: Sauce[]): Sauce[] {
...
// spice level.
function gimmeSpicy(arrayOfSauces: Sauce[], spiceLevel: number): Sauce[] {
